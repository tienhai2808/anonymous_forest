...
export default function SideBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 sm:w-[88px] w-full h-auto sm:h-screen flex sm:flex-col items-center flex-row bg-gray-100 dark:bg-neutral-900 z-100">
      <div
